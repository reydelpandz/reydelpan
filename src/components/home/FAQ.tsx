...
const FAQ = () => {
    const data = [
        ...
        {
            question: "هل تقدمون خبزًا مناسبًا لمن يعاني من حساسية الغلوتين؟",
            answer: "نعم، نوفر بعض الخيارات الخالية من الغلوتين، ولكن يتم تحضيرها في بيئة قد تحتوي على آثار بسيطة من الغلوتين.",
        },
    ];
